...
\projectinfo{
  ...
  %Nazev prace
  title.cs={Nástroj pro analýzu výkonu alokátorż pamżti v operażním systému Linux},  %nazev prace v cestine
  ...
  %Skolitel
  supervisor= Tomáż Vojnar, %jmeno prijmeni skolitele
  ...
  %===========================================================================
  %Klicova slova
  keywords.cs={malloc}, %klicova slova v ceskem jazyce
  keywords.en={malloc}, %klicova slova v anglickem jazyce
  %Abstract
